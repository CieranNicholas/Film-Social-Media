				...
				<section className='flex items-end justify-start gap-4 bg-neutral-800 rounded-md p-4 w-full'>
					...
					>
						...
						<div className='w-24 h-24 rounded-full overflow-hidden'>
							<img className='w-full h-full object-cover object-center' src={user.image as string} alt='Avatar' />
						</div>

						<input type='url' className='text-black px-4 py-2' name='url' placeholder='image url' />
						<input type='submit' value='Update Image' className=' px-4 py-2 bg-white text-black rounded shadow' />
					</form>
				</section>
			</div>
		</main>
